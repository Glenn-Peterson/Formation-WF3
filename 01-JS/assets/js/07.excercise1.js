...
/* EXERCICE */
/** function QuelEstVotrePrenom() {
*   alert("Bonjour quel est votre prénom ?");
*   QuelEstVotrePrenom = prompt(Prenom, '');
*   }
*   @param {string} Prenom
*
*   function ditQuelEstVotrePrenom(Prenom,) {
*   document.write("<p>Bonjour <strong>" + Prenom + "</strong>Quel age as-tu ?</p>");
*   }
*
*   function QuelAgeAsTu() {
*   QuelAgeAsTu = prompt(Age, '');
*   alert("Tu est donc né en" );
*   }
*   @param {string} Age
*   var Prenom, Age, nb1, nb2, resultats;
*   nb1 = */
