...
/*console.clear();
var listeDeNoms = ["Legoux", "Balasubramaniam", "Benallal", "Cantat"];
var listeDePrenoms = ["Julien", "Pransun", "Cheffia", "Pascal"];
var telephone = ["0612345678", "0698765432", "0645678921", "0635748596"];
var AnnuaireDesStagiaires = [listeDeNoms, listeDePrenoms, telephone];
...
console.log(Contacts[0].nom);
console.log(Contacts[0].coordonnees.adresse.region);
console.log(Contacts[1].nom);
console.log(Contacts[1].coordonnees.adresse.region);
console.log(Contacts[2].nom);
console.log(Contacts[2].coordonnees.adresse.region);
